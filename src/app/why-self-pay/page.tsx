        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <FadeIn direction="up">
            ...
            <p className="font-sans text-base sm:text-lg text-primary/80 leading-relaxed max-w-2xl mx-auto">
              Because your recovery deserves to come first. Our self-pay model allows us to focus on what you actually need — not what an insurance company says you need.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-7">
              <FadeIn direction="left">
                <div className="font-sans text-base sm:text-lg text-primary/85 space-y-6 leading-relaxed">
                  <p>
                    When it comes to your health, you deserve undivided attention and a recovery path built around your actual capabilities. In a traditional medical billing setup, that is rarely what happens. By choosing a <strong>self-pay physical therapy</strong> model, we operate entirely out-of-network, placing the control of your recovery back where it belongs: with you and your therapist.
                  </p>
                  <p>
                    In practice, choosing <strong>cash-pay PT in Shelbyville, KY</strong> means you never have an insurance company adjuster dictating how long your sessions can be, how many total visits you are allowed, or what specific treatment modalities you are approved to receive. Your care plan is built strictly around your personal physical goals — not billing codes or pre-authorizations.
                  </p>
                  <p>
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-28">
              <FadeIn direction="right">
                <div className="relative aspect-[3/2] w-full rounded-[2rem] overflow-hidden shadow-sm border border-secondary/15">
                  <Image
                    src="/images/7.jpg"
